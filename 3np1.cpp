// program that calculates hailstone sequences
#include <iostream>

// function prototypes
bool isOdd(int n);              // return true if n is odd otherwise return false
int len3nplus1(int n);          // return the number of elements in the 3n+1 sequence of n
int sumSeq3nPlus1(int n);       // returns the sum of the 3n+1 sequence
int longestSequence(int max);   // returns the number in the range from 1 to max that has the longest 3n+1 sequence; if there is more than 1, return the first one. 
